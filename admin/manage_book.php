...
<doctype html>
  ...
  <div class="container">
  	<div class="row  justify-content-center">
          ...
          <h3 class="text-center font-weight-bold">Manage Books</h3>
          <table class="table table-responsive">
              ...
              <?php
               $cnt=1;
               $sql="SELECT tblbooks.book_name,tblcategory.categoryname,tblauthor.author_name,tblbooks.isbn,tblbooks.id FROM tblbooks JOIN tblcategory on tblbooks.category_id =tblcategory.id JOIN tblauthor on tblauthor.id=tblbooks.author_id ";
                   ...
                   while($row = $result->fetch_assoc()){?>
                     <tbody>
                      <tr>
                          ...
                          <td><a href="edit_book.php?id=<?php echo htmlentities($row['id']);?>"> <input type="button" class="btn btn-success" name="edit" value="Edit"></a> <a href="manage_book.php?del=<?php echo htmlentities($row['id']);?>"><input class="btn btn-danger" type="button" name="delete" value="delete"></td>
                      </tr>
                      <?php $cnt=$cnt+1; ?>
                      <?php } ?>
                      <?php } ?>
